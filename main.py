...
def main():
    ...
    backGroundimg = tk.PhotoImage(file="beautiful_Gui/backGroundImg.png")
    label = tk.Label(root, image=backGroundimg)
    label.place(x=0, y=0)
    # backGroundimgLabel =tk.Label()
    # backGroundimg.
    global img_path_entry, img, rows, cols
    ...
    b_waves_button = TkinterCustomButton(text="Waves", corner_radius=0, command=click)
